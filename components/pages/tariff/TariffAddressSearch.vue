<template>
  <div>
    <template v-if="!showLoadingModal">
      ...
      <div
        v-if="tariffCheckStatus === tariffCheckTypes.AVALILABLE && !callToAdressSearch"
      ...
      <div
        v-if="tariffCheckStatus === tariffCheckTypes.OTHER_AVALIABLE && !callToAdressSearch"
        class=""
      >
      ...
      <div
        v-if="tariffCheckStatus === tariffCheckTypes.NOT_AVALIABLE && !callToAdressSearch"
        class=""
      >
        <div class="tariffProvider__checkUnsuccess-container">
          <div class="tariffProvider__checkUnsuccess-address">
    ...
    <template v-if="showLoadingModal">
      <div
        v-if="tariffCheckStatus !== tariffCheckTypes.AVALILABLE"
        id="providerChecking"
...
<style lang="scss" scoped>
  ...
  .adress-check--check::before{
    position: absolute;
    right: 112px;
    content: url("~@/assets/images/sprite-svg/arrow-right.svg");
  }
  .tariffProvider__checkUnsuccess {
    &-container {
      padding: 20px;
    }
    &-address-text {
  ...
  .adderess-not-avalible-container {
    padding: 20px 0;
    display: flex;
  ...
  .svg-image-success {
    background-image: url("~assets/images/sprite-svg/success.svg");
    width: 45px;
    height: 45px;
