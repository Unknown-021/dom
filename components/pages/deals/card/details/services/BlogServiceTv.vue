  ...
  <div class="card__position">
    <div class="card__position-row">
      <div class="card__position-item">
        <div style="padding-top: 5px;" class="card__position-icon">
      ...
      <div v-if="renderDevices.length" class="card__position-item">
...
import { DealDevice, DealTvPackage, ServiceTv } from '~/types/deals'
...
export default Vue.extend({
  ...
  computed: {
    renderDevices (): DealDevice[] {
      // Get routers
      return this.device.filter(el => el.device === 2)
    },
